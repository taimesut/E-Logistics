...
const ShipperParcelGetAll = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: 'status',
            key: 'status',
            render: status => GetStatusDescription(status, "SHIPPER")
        },
        {
            title: 'Cập nhật',
            dataIndex: 'updateAt',
        ...
        },
        {
            title: 'Hành động',
            render: parcel => (
                <Button type="primary" onClick={() => navigate(`/shipper/parcel/${parcel.id}`)}>Xem</Button>
            )
        }
    ];
...
export default ShipperParcelGetAll;
