...
import { Table, Input, Select, Button, Space, message, Card, Row, Col, Spin, Typography } from "antd";
...
const CustomerParcelGetAll = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: 'status',
            key: 'status',
            render: status => GetStatusDescription(status, "CUSTOMER"),
        },
        {
            title: 'Cập nhật',
            dataIndex: 'updateAt',
        ...
        },
        {
            title: 'Hành động',
            render: (parcel) => (
                <Button type="primary" onClick={() => navigate(`/customer/parcel/${parcel.id}`)}>Xem</Button>
            ),
        },
    ];
                ...
                <Row gutter={16} align="middle">
                    ...
                    <Col>
                        <Space>
                            ...
                            <Button type="primary" onClick={() => navigate('/customer/create-parcel/')}>Tạo đơn hàng</Button>
                        </Space>
                    </Col>
                </Row>
            </Card>
...
export default CustomerParcelGetAll;
